...
func (a *App) routes() {
	...
	a.mux.HandleFunc("GET /api/export/resolution.docx", api.RequireAdmin(api.ExportResolutionDocx))
	a.mux.HandleFunc("GET /api/export/resolution.pdf", api.RequireAdmin(api.ExportResolutionPDF))
	a.mux.HandleFunc("GET /api/export/all-data", api.RequireAdmin(api.ExportAllData))
